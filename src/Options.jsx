      ...
      {categories && (
        <>
          ...
          >
            ...
            <input type="number" className="quantity" id="quantity" name="quantity" min="1" max="50" onChange={changeNumQ} placeholder="type a number"></input>
            <br></br>
            <Link
            ...
            >
              <button className="categorysubmit" disabled={!(numQ > 0 && numQ < 51)}> Start</button>
              {/*!(numQ > 0 && numQ < 51)*/}
